...
\begin{tabular}{lccc}
\toprule
Configura\c{c}\~ao & F1 & Precis\~ao & Sensibilidade \\
\midrule
\textbf{XGBoost $\geq$0.5} & \textbf{0.924 $\pm$ 0.030} & \textbf{0.951 $\pm$ 0.036} & \textbf{0.901 $\pm$ 0.048} \\
...
\begin{tablenotes}
\small
\item Nota: O estudo de abla\c{c}\~ao original utilizou RF+SMOTE e Gradient Boosting como classificadores-base. Os resultados com XGBoost foram obtidos sob as mesmas condi\c{c}\~oes experimentais (5-\textit{fold}, seed=42, split=0.3).
\end{tablenotes}
\end{table}
