...
\midrule
XGBoost $\geq$0.5 & \textbf{0.924 $\pm$ 0.030} & 0.951 $\pm$ 0.036 & 0.901 $\pm$ 0.048 \\
...
\end{tabular}
\vspace{2pt}
\par\small Nota: A abla\c{c}\~ao original utilizou RF+SMOTE e GB como classificadores-base. Os resultados com XGBoost foram adicionados sob as mesmas condi\c{c}\~oes experimentais (5-\textit{fold} $\times$ 5 repeti\c{c}\~oes, seed=42, \textit{split}=0,3).
\end{table}
