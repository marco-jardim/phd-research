...
\noindent
\begin{longtable}{@{}l@{\hspace{1.5em}}p{12cm}@{}}
...
CID-10   & Classifica\c{c}\~{a}o Internacional de Doen\c{c}as, 10\textordfeminine{} revis\~{a}o \\[6pt]
CNS      & Cart\~{a}o Nacional de Sa\'{u}de \\[6pt]
CV       & \textit{Cross-Validation} --- valida\c{c}\~{a}o cruzada \\[6pt]
EVR      & \textit{Expected Value of Review} --- Valor Esperado da Revis\~{a}o \\[6pt]
...
MACD     & Medidas Cont\'{i}nuas de Diferen\c{c}a de Datas \\[6pt]
...
SIS      & Sistema de Informa\c{c}\~{a}o em Sa\'{u}de \\[6pt]
