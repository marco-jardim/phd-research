...
O experimento empregou o modelo Kimi K2.5, acessado pela API Fireworks \cite{Fireworks2025}, com temperatura fixa em $0{,}0$ e semente determinística (\textit{seed}~$=43$) para garantir reprodutibilidade.
...
A correção de Benjamini-Hochberg para taxa de falsas descobertas (\textit{FDR}) a $\alpha = 0{,}05$ foi aplicada conjuntamente aos 36 testes \cite{BenjaminiHochberg1995}.
