...
4 & Revisão LLM \textit{dual-agent} & 41 & 2--3 chamadas API REST por par & $O(s)$ & $\approx$\,5\,s & $\approx$\,200\,s \\
\hline
\end{tabular}%
}
\end{table}
