...
3 & Calibração Platt + motor de perda & 18.799 & Sigmoide, 3 perdas esperadas, ordenação EVR & $O(n \log n)$ & $\approx$\,3\,$\mu$s & $\approx$\,50\,ms \\
